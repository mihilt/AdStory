...
INSERT INTO PNT_LOG VALUES(SEQ_PNT_LOG.NEXTVAL, (SELECT KEY FROM MEMBER WHERE MEMBER_ID ='kimdh'), NULL, SYSDATE, 100, 'A', (SELECT POINT FROM MEMBER WHERE MEMBER_ID ='kimdh'));
