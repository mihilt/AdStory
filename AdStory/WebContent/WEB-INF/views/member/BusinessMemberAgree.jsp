...
<body>
	...
	<form action="<%=request.getContextPath()%>/member/businessEnroll"
		id="joinForm" name="agreeFrm">
...
AD Story 서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다. 본 약관은 다양한 AD Story 서비스의 이용과 관련하여 네이버 서비스를 제공하는 AD Story 주식회사(이하 ‘AD Story’)와 이를 이용하는 AD Story서비스 회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며, 아울러 여러분의 AD Story 서비스 이용에 도움이 될 수 있는 유익한 정보를 포함하고 있습니다.
			...
			<li class="checkBox check03">
				<ul class="clearfix">
					...
					<li class="checkBtn"><input type="checkbox" name="chk"
						required></li>
				</ul> <textarea name="" id="">개인정보보호법에 따라 AD Story에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
개인정보보호법에 따라 AD Story에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
			...
			<li class="checkBox check03">
				...
				</ul> <textarea name="" id="">위치정보 이용약관에 동의하시면, 위치를 활용한 광고 정보 수신 등을 포함하는 AD Story 위치기반 서비스를 이용할 수 있습니다.
