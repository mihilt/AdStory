...
<%
int categoryKey = Integer.parseInt((String)request.getAttribute("categoryKey"));
...
<nav
   ...
   <%if(categoryList != null ){
      ...
      %>
      <a
         class="<%=c.getKey()==categoryKey?"text-blue-400 ":"text-gray-700 hover:text-blue-700 " %> mt-3 hover:underline sm:mx-3 sm:mt-0"
