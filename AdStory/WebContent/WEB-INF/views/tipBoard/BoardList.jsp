...
<div class = "m-12">  
   ...
   <%    }     %>   
	   ...
	   <% } %>
        ...
        <div id="search-memberId" class="flex m-auto mt-5">
            <form class="m-auto" action="<%=request.getContextPath()%>/tipBoard/search">
                ...
                <input class= "px-5 py-1 text-gray-700 bg-gray-200 rounded" type="text" name="searchKeyword"  size="10" placeholder=""/>
